...
import { Usos7_1_0Handler } from "./v7.1.0/handler"
...
const handlers: Handler[] = [new Usos7_1_0Handler(), new Usos7_0_0Handler(), new Usos6_8_1Handler(), new Usos6_8_0Handler(), new Usos6_7Handler()] // In order from newest to oldest
